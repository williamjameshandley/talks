...
## Academic talks
1. The Ambient AI Lab
    - "AI for Scientific Practice" workshop, a Kavli Astrophysics Symposium satellite day, Hoyle Lecture Theatre, Institute of Astronomy, Cambridge
    - [PDF](https://github.com/williamjameshandley/talks/raw/kas_2026/will_handley_kas_2026.pdf)
    - [source](https://github.com/williamjameshandley/talks/tree/kas_2026)
    - _Sep 2026_
2. Bayesian Techniques for GNSS-R
    - GLITTER Training School, University of Luxembourg
    - [PDF](https://github.com/williamjameshandley/talks/raw/glitter_2026/will_handley_glitter_2026.pdf)
    - [source](https://github.com/williamjameshandley/talks/tree/glitter_2026)
    - [workshop materials](https://github.com/handley-lab/workshop-glitter)
    - _Apr 2026_
3. Classical inference at scale: dark energy, tensions, and the GPU revolution
...
4. The New Scientific Method
    ...
    - _Feb 2026_
5. Two Revolutions: GPUs for Science, AI for Scientists
    ...
    - _Jan 2026_
6. AI/ML Tools for Research
    - GAMBIT LLMBit Workshop, Oslo
    - [PDF](https://github.com/williamjameshandley/talks/raw/gambit_llmbit_2025/gambit_llmbit_2025.pdf)
    - [source](https://github.com/williamjameshandley/talks/tree/gambit_llmbit_2025)
    - _Dec 2025_
7. GPU Accelerated Bayesian Inference for Astronomy
    - Talk given at University of Birmingham
    - [PDF](https://github.com/williamjameshandley/talks/raw/birmingham_2025/will_handley_birmingham_2025.pdf)
    - [source](https://github.com/williamjameshandley/talks/tree/birmingham_2025)
    - _Oct 2025_
8. GPU Accelerated Nested Sampling for 21-cm Cosmology
    - Talk given at Caltech
    - [PDF](https://github.com/williamjameshandley/talks/raw/caltech_2025/will_handley_caltech_2025.pdf)
    - [source](https://github.com/williamjameshandley/talks/tree/caltech_2025)
    - _Jan 2025_
9. Next-Generation Model Comparison for Primordial Cosmology
    - Talk given at [LMU Munich](https://indico.physik.uni-muenchen.de/event/570/)
    - [PDF](https://github.com/williamjameshandley/talks/raw/lmu_2025/will_handley_lmu_2025.pdf)  
    - [source](https://github.com/williamjameshandley/talks/tree/lmu_2025) 
    - _Sep 2025_
10. AI/ML Tools for Research
    ...
    - _Jul 2025_
11. A Statistician's Guide to the Galaxy (Fitting Zoo)
    ...
    - [source](https://github.com/williamjameshandley/talks/tree/sed_2025) 
    - _Jul 2025_
12. GPU Accelerated Nested Sampling
    ...
    - _Jun 2025_
13. lsbi: linear simulation based inference
    ...
    - _Jun 2025_
14. GPU-native nested sampling in BlackJAX: For simulation-based inference at scale
    - Workshop talk given at [SBI Galaxy Evolution 2025](https://sbi-galaxy-evolution-2025.github.io/), Bristol
    ...
    - _May 2025_
15. Scanning for cosmological tensions across a DiRAC-enabled grid of models, datasets and samplers 
    ...
    - [source](https://github.com/williamjameshandley/talks/tree/cosmoverse_2025) 
    - _May 2025_
16. Cosmological tensions? A guide for high energy theorists
    ...
    - [source](https://github.com/williamjameshandley/talks/tree/damtp_2025) 
    - _Jan 2025_
17. Theory meets experiment 2025: New frontiers in particle cosmology  
    ...
    - _Jan 2025_
18. Next-generation statistical inference tools: Simulation-based inference, marginal statistics & accelerated nested sampling 
    ...
    - _Dec 2024_
19. PolySwyft: a sequential simulation-based nested sampler
    ...
    - _Oct 2024_
20. lsbi: linear simulation based inference 
    ...
    - _Sep 2024_
21. Nested sampling: powering next-generation inference and machine learning tools for astrophysics, cosmology, particle physics and beyond  
    ...
    - _Aug 2024_
22. Sampling methods for high energy physics & particle astrophysics
    ...
    - _Aug 2024_
23. Nested sampling: powering next-generation inference and machine learning tools for astrophysics, cosmology, particle physics and beyond  
    ...
    - _Aug 2024_
24. Nested sampling: powering next-generation inference and machine learning tools for astrophysics, cosmology, particle physics and beyond  
    ...
    - _Jul 2024_
25. PolySwyft: a sequential simulation-based nested sampler
    - talk given at [CosmoVerse 2024](https://indico.oa.uj.edu.pl/event/3/timetable/#all.detailed)
    - [PDF](https://github.com/williamjameshandley/talks/raw/cosmoverse_2024/will_handley_cosmoverse_2024.pdf)  
    - [source](https://github.com/williamjameshandley/talks/tree/cosmoverse_2024) 
    - _Jul 2024_
26. The scaling frontier of nested sampling
    - talk given at [MaxEnt 2024](https://maxent2024.ugent.be/)
    ...
    - _Jul 2024_
27. Resonant or asymmetric: The status of sub-GeV dark matter
    ...
    - _Jun 2024_
28. Next generation astrophysical inference across the interdisciplinary frontier
    ...
    - _May 2024_
29. PolySwyft: a sequential simulation-based nested sampler
    - Talk given at [PhyStat 2024](https://indico.cern.ch/event/1355601/timetable/#20240516) 
    ...
    - _May 2024_
30. Next generation astrophysical inference across the interdisciplinary frontier
    ...
    - _April 2024_
31. Nested sampling: powering next-generation inference and machine learning tools for astrophysics, cosmology, particle physics and beyond  
    - Talk given to [Gatsby computational neuroscience unit](https://www.ucl.ac.uk/gatsby/gatsby-computational-neuroscience-unit)
    - [PDF](https://github.com/williamjameshandley/talks/raw/gatsby_2024/will_handley_gatsby_2024.pdf)  
    - [source](https://github.com/williamjameshandley/talks/tree/gatsby_2024)
    - _March 2024_
32. Sampling techniques in high-dimensional parameter spaces with ScannerBit 2.0 
    - Talk given to [Munich ORIGINS cluster](https://www.origins-cluster.de/)
    - [PDF](https://github.com/williamjameshandley/talks/raw/munich_2024/will_handley_munich_2024.pdf)  
    - [source](https://github.com/williamjameshandley/talks/tree/munich_2024)
    - _Feb 2024_
33. Next-generation inference tools for cosmology and beyond 
    ...
    - _Jan 2024_
34. Simulation Based Inference: theory, sampling & model comparison
    ...
    - _Jan 2024_
35. Nested sampling: powering next-generation inference and machine learning tools for astrophysics, cosmology, particle physics and beyond  
    - Plenary talk at [Advanced statistical tools](https://www.fisica.unam.mx/workshops/advanced_statistical_tools), UNAM, Mexico
    - [PDF](https://github.com/williamjameshandley/talks/raw/unam_2023/will_handley_unam_2023.pdf)  
    - [source](https://github.com/williamjameshandley/talks/tree/unam_2023)
    - _Dec 2023_
36. unimpeded: Universal model comparison and parameter estimation distributed over every dataset
    - [OKC@15](https://indico.fysik.su.se/event/8274/), Stockholm, Sweden
    - [PDF](https://github.com/williamjameshandley/talks/raw/stockholm_2023/will_handley_stockholm_2023.pdf)  
    - [source](https://github.com/williamjameshandley/talks/tree/stockholm_2023)
    - _Oct 2023_    
37. Cosmological inference tools: marginal statistics and fully Bayesian forecasts.
    ...
    - _Oct 2023_    
38. Nested sampling: powering next-generation inference and machine learning tools for astrophysics, cosmology, particle physics and beyond 
    - Manchester, UK
    - [PDF](https://github.com/williamjameshandley/talks/raw/manchester_2023/will_handley_manchester_2023.pdf)  
    - [source](https://github.com/williamjameshandley/talks/tree/manchester_2023)
    - _Oct 2023_   
39. Nested sampling tools
    - [REACH AGM](https://www.um.edu.mt/events/reachworkshop2023), Malta
    - [PDF](https://github.com/williamjameshandley/talks/raw/reach_2023/will_handley_reach_2023.pdf)  
    - [source](https://github.com/williamjameshandley/talks/tree/reach_2023)
    - _Sep 2023_    
40. Nested sampling: powering next-generation inference and machine learning tools for astrophysics, cosmology, particle physics and beyond 
    - UCL, UK
    - [PDF](https://github.com/williamjameshandley/talks/raw/ucl_2023/will_handley_ucl_2023.pdf)
    - [source](https://github.com/williamjameshandley/talks/tree/ucl_2023)
    - _Sep 2023_   
41. Nested sampling: powering next-generation inference and machine learning tools for cosmology, particle physics and beyond 
    - King's college, London, UK
    - [PDF](https://github.com/williamjameshandley/talks/raw/kcl_2023/will_handley_kcl_2023.pdf)  
    - [source](https://github.com/williamjameshandley/talks/tree/kcl_2023)
    - _Aug 2023_   
42. The scaling frontier of nested sampling: Summary talk
    - Conference summary talk Frontiers of nested sampling [NS2023](https://www.ipp.mpg.de/maxent2023)
    - [PDF](https://github.com/williamjameshandley/talks/raw/maxent_2023/will_handley_maxent_2023.pdf)  
    - [source](https://github.com/williamjameshandley/talks/tree/maxent_2023)
    - _Jul 2023_   
43. Gradients and nested sampling: The present state of the art
    ...
    - _Jun 2023_  
44. Nested Sampling: A multi-purpose numerical tool for science and machine learning
    - Invited seminar at ETH Zurich 
    - [PDF](https://github.com/williamjameshandley/talks/raw/zurich_2023/will_handley_zurich_2023.pdf)  
    - [source](https://github.com/williamjameshandley/talks/tree/zurich_2023)
    - _Mar 2023_  
45. High dimensional nested sampling
    ...
    - _Jan 2023_  
46. Nested sampling: powering the next-generation of Bayesian inference tools for cosmology, particle physics and beyond
    ...
    - _Dec 2022_  
47. Theory, observation & cosmological inference 
    ...
    - _Dec 2022_  
48. Next generation cosmological analysis with nested sampling
    ...
    - _Sep 2022_  
49. Next generation cosmological analysis with nested sampling
    ...
    - _Sep 2022_  
50. Nested Sampling: An efficient and robust Bayesian inference tool for particle physics and cosmology
    ...
    - _Jul 2022_  
51. Frontiers of nested sampling
    ...
    - _Jul 2022_  
52. Nested Sampling and Likelihood Free Inference
    ...
    - _Apr 2022_  
53. Statistical methods in cosmology
    ...
    - _Apr 2022_  
54. Review on Statistical Tools and Samplers
    - [TOOLS 2021](https://indico.cern.ch/event/1076291/) 
    - [PDF](https://github.com/williamjameshandley/talks/raw/tools_2021/will_handley_tools_2021.pdf)  
    - [source](https://github.com/williamjameshandley/talks/tree/tools_2021)
    - _Nov 2021_  
55. Bayesian methods for quantifying global parameter tensions between cosmological datasets
    ...
    - _Feb 2021_ 
56. Nested sampling: An efficient and robust Bayesian inference tool for 21cm cosmology 
    ...
    - _Oct 2020_ 
57. Nested Sampling: An efficient and robust Bayesian inference tool for physics and machine learning
    ...
    - _Feb 2020_  
58. Nested Sampling: An efficient and robust Bayesian inference tool for astrophysics and cosmology
    ...
    - _Jan 2020_  
59. Quantised primordial power spectra
    ...
    - _Dec 2019_  
60. Nested Sampling: an efficient and robust Bayesian inference tool for Machine Learning and Data Science
    ...
    - _Nov 2019_  
61. Curvature tension: Evidence for a closed universe (?)
    ...
    - _Aug 2019_  
62. Quantifying cosmological tensions
...
63. Likelihood free inference
    ...
    - _Jun 2019_  
64. Compromise-free Bayesian sparse reconstruction
    ...
    - _Mar 2019_  
65. Inflation, curvature and kinetic dominance 
    ...
    - _Dec 2018_  
66. BAMBI: Resurrection -- Blind Accelerated Multimodal Bayesian Inference 
    ...
    - _Nov 2018_  
67. Nested Sampling: an efficient and robust Bayesian inference tool for cosmology and particle physics 
    - [DarkMachines](https://darkmachines.org/) community online
    ...
    - _Nov 2018_  
68. Bayesian inference: The state of the art in cosmology and astrophysics
    ...
    - Oct 2018
69. Planck, inflation and the future of inflationary constraints 
    ...
    - May 2018
70. MaxEnt priors with derived parameters in a specified distribution
    - Battcock coffee-time mini-seminar, Cambridge
    ...
    - May 2018
71. Nested Sampling: an efficient and robust Bayesian inference tool for astrophysics and cosmology 
...
73. Modern Bayesian Inference
    ...
    - April 2017
74. Statistics
    - [The IFT School on Cosmology Tools 2017](https://workshops.ift.uam-csic.es/cosmotools2017) in IFT, Madrid
    - [source](https://github.com/williamjameshandley/talks/tree/madrid_2017) 
    - [PDF](https://github.com/williamjameshandley/talks/raw/madrid_2017/will_handley_madrid_2017.pdf) 
    - March 2017
75. PolyChord 2.0: Advances in Nested Sampling with astrophysical applications
    ...
    - Feb 2017
76. PolyChord 2.0 and the future of nested sampling
    - September 2016 
...
77. PolyChord 2.0 and the future of nested sampling
    - May 2016 
...
78. PolyChord and the future of nested sampling
    - Mar 2016 
...
79. PolyChord: next generation nested sampling
    - Dec 2015 
