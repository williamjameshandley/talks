...
## Academic talks
1. GPU-native nested sampling in BlackJAX: For simulation-based inference at scale
    ...
    - _May 2025_
2. Scanning for cosmological tensions across a DiRAC-enabled grid of models, datasets and samplers 
    ...
    - _May 2025_
3. Cosmological tensions? A guide for high energy theorists
    ...
    - _Jan 2025_
4. Theory meets experiment 2025: New frontiers in particle cosmology  
    ...
    - _Jan 2025_
5. Next-generation statistical inference tools: Simulation-based inference, marginal statistics & accelerated nested sampling 
    ...
    - _Dec 2024_
6. PolySwyft: a sequential simulation-based nested sampler
...
7. lsbi: linear simulation based inference 
    ...
    - _Sep 2024_
8. Nested sampling: powering next-generation inference and machine learning tools for astrophysics, cosmology, particle physics and beyond  
    ...
    - _Aug 2024_
9. Sampling methods for high energy physics & particle astrophysics
...
12. PolySwyft: a sequential simulation-based nested sampler
    ...
    - _Jul 2024_
13. The scaling frontier of nested sampling
    ...
    - _Jul 2024_
14. Resonant or asymmetric: The status of sub-GeV dark matter
    ...
    - _Jun 2024_
15. Next generation astrophysical inference across the interdisciplinary frontier
...
18. Nested sampling: powering next-generation inference and machine learning tools for astrophysics, cosmology, particle physics and beyond  
    ...
    - _March 2024_
19. Sampling techniques in high-dimensional parameter spaces with ScannerBit 2.0 
    ...
    - _Feb 2024_
20. Next-generation inference tools for cosmology and beyond 
    ...
    - _Jan 2024_
21. Simulation Based Inference: theory, sampling & model comparison
...
22. Nested sampling: powering next-generation inference and machine learning tools for astrophysics, cosmology, particle physics and beyond  
    ...
    - _Dec 2023_
23. unimpeded: Universal model comparison and parameter estimation distributed over every dataset
    ...
    - _Oct 2023_    
24. Cosmological inference tools: marginal statistics and fully Bayesian forecasts.
...
27. Nested sampling: powering next-generation inference and machine learning tools for astrophysics, cosmology, particle physics and beyond 
    ...
    - _Sep 2023_   
28. Nested sampling: powering next-generation inference and machine learning tools for cosmology, particle physics and beyond 
    ...
    - _Aug 2023_   
29. The scaling frontier of nested sampling: Summary talk
    ...
    - _Jul 2023_   
30. Gradients and nested sampling: The present state of the art
    ...
    - _Jun 2023_  
31. Nested Sampling: A multi-purpose numerical tool for science and machine learning
    ...
    - _Mar 2023_  
32. High dimensional nested sampling
    ...
    - _Jan 2023_  
33. Nested sampling: powering the next-generation of Bayesian inference tools for cosmology, particle physics and beyond
    ...
    - _Dec 2022_  
34. Theory, observation & cosmological inference 
    ...
    - _Dec 2022_  
35. Next generation cosmological analysis with nested sampling
...
36. Next generation cosmological analysis with nested sampling
    ...
    - _Sep 2022_  
37. Nested Sampling: An efficient and robust Bayesian inference tool for particle physics and cosmology
    ...
    - _Jul 2022_  
38. Frontiers of nested sampling
    ...
    - _Jul 2022_  
39. Nested Sampling and Likelihood Free Inference
    ...
    - _Apr 2022_  
40. Statistical methods in cosmology
    ...
    - _Apr 2022_  
41. Review on Statistical Tools and Samplers
    ...
    - _Nov 2021_  
42. Bayesian methods for quantifying global parameter tensions between cosmological datasets
    ...
    - _Feb 2021_ 
43. Nested sampling: An efficient and robust Bayesian inference tool for 21cm cosmology 
    ...
    - _Oct 2020_ 
44. Nested Sampling: An efficient and robust Bayesian inference tool for physics and machine learning
    ...
    - _Feb 2020_  
45. Nested Sampling: An efficient and robust Bayesian inference tool for astrophysics and cosmology
    ...
    - _Jan 2020_  
46. Quantised primordial power spectra
    ...
    - _Dec 2019_  
47. Nested Sampling: an efficient and robust Bayesian inference tool for Machine Learning and Data Science
    ...
    - _Nov 2019_  
48. Curvature tension: Evidence for a closed universe (?)
    ...
    - _Aug 2019_  
49. Quantifying cosmological tensions
...
50. Likelihood free inference
    ...
    - _Jun 2019_  
51. Compromise-free Bayesian sparse reconstruction
    ...
    - _Mar 2019_  
52. Inflation, curvature and kinetic dominance 
    ...
    - _Dec 2018_  
53. BAMBI: Resurrection -- Blind Accelerated Multimodal Bayesian Inference 
    ...
    - _Nov 2018_  
54. Nested Sampling: an efficient and robust Bayesian inference tool for cosmology and particle physics 
    - [DarkMachines](https://darkmachines.org/) community online
    ...
    - _Nov 2018_  
55. Bayesian inference: The state of the art in cosmology and astrophysics
    ...
    - Oct 2018
56. Planck, inflation and the future of inflationary constraints 
    ...
    - May 2018
57. MaxEnt priors with derived parameters in a specified distribution
...
61. Statistics
    ...
    - March 2017
62. PolyChord 2.0: Advances in Nested Sampling with astrophysical applications
    ...
    - Feb 2017
63. PolyChord 2.0 and the future of nested sampling
    - September 2016 
...
65. PolyChord and the future of nested sampling
    - Mar 2016 
...
66. PolyChord: next generation nested sampling
    - Dec 2015 
