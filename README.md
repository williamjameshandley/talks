...
1. AI/ML Tools for Research
    ...
    - _Jul 2025_
2. A Statistician's Guide to the Galaxy (Fitting Zoo)
    ...
    - _Jul 2025_
3. GPU Accelerated Nested Sampling
...
4. lsbi: linear simulation based inference
    ...
    - _Jun 2025_
5. GPU-native nested sampling in BlackJAX: For simulation-based inference at scale
    ...
    - _May 2025_
6. Scanning for cosmological tensions across a DiRAC-enabled grid of models, datasets and samplers 
    ...
    - _May 2025_
7. Cosmological tensions? A guide for high energy theorists
    ...
    - _Jan 2025_
8. Theory meets experiment 2025: New frontiers in particle cosmology  
    ...
    - _Jan 2025_
9. Next-generation statistical inference tools: Simulation-based inference, marginal statistics & accelerated nested sampling 
    ...
    - _Dec 2024_
10. PolySwyft: a sequential simulation-based nested sampler
...
11. lsbi: linear simulation based inference 
    ...
    - _Sep 2024_
12. Nested sampling: powering next-generation inference and machine learning tools for astrophysics, cosmology, particle physics and beyond  
    ...
    - _Aug 2024_
13. Sampling methods for high energy physics & particle astrophysics
...
16. PolySwyft: a sequential simulation-based nested sampler
    ...
    - _Jul 2024_
17. The scaling frontier of nested sampling
    ...
    - _Jul 2024_
18. Resonant or asymmetric: The status of sub-GeV dark matter
    ...
    - _Jun 2024_
18. Next generation astrophysical inference across the interdisciplinary frontier
