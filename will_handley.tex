...
%TODO work on this plot to make it curvier/more lsbi
\begin{frame}
...
\begin{frame}
    ...
    \begin{columns}
        ...
        %TODO include examples of SBI in weak lensing
    \end{columns}
    
\end{frame}

%TODO include graph that indicates classification problem
\begin{frame}
    ...
    and by definition
        \begin{itemize}
            \item $\C[4]{\mathcal{J}(D,\theta)} = P(\theta,D|M_{\C[4]{\mathcal{J}}})$
...
%TODO emphasise cosmology from this paper
\begin{frame}
...
%TODO update this with latest plot
\begin{frame}
