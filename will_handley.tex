...
\begin{frame}
    \frametitle{Recent GPU-Accelerated Nested Sampling Applications}
    \framesubtitle{CMB and Cosmic Shear \arxiv{2405.12965}}
...
\begin{frame}
    \frametitle{Recent GPU-Accelerated Nested Sampling Applications}
    \framesubtitle{Bayesian Anomaly Detection for Type Ia Supernovae \arxiv{2509.13394}}
...
\begin{frame}
    \frametitle{Recent GPU-Accelerated Nested Sampling Applications}
    \framesubtitle{Dark Energy vs Supernova Systematics \arxiv{2509.13220}}
...
\begin{frame}
    \frametitle{Recent GPU-Accelerated Nested Sampling Applications}
    \framesubtitle{Gravitational Wave Inference \arxiv{2509.04336}}
