...
\begin{frame}
    ...
    \framesubtitle{The same mathematical problem in different guises}
    \begin{columns}[T]
        \column{0.32\textwidth}
        \begin{block}{Cosmology}
            \textbf{Parameters}: $H_0$, $\Omega_m$, $w$
            \begin{itemize}
                \item $\Lambda$CDM vs $w$CDM?
                \item Is dark energy evolving?
            \end{itemize}
            \vspace{5pt}
            \centering
            \includegraphics[width=0.9\textwidth]{figures/desi.pdf}
        \end{block}
        \column{0.32\textwidth}
        \begin{block}{Gravitational Waves}
            \textbf{Parameters}: masses, spins, sky position
            \begin{itemize}
                \item NS-NS vs BH-BH?
                \item EM follow-up needs localisation
            \end{itemize}
            \vspace{5pt}
            \centering
            \includegraphics[width=0.9\textwidth]{figures/gw_localisation.jpg}
        \end{block}
        \column{0.32\textwidth}
        \begin{block}{Exoplanets}
            \textbf{Parameters}: period, radius, inclination
            \begin{itemize}
                \item How many planets?
                \item Avoid overfitting noise
            \end{itemize}
            \vspace{5pt}
            \centering
            \includegraphics[width=0.9\textwidth]{figures/exoplanet.pdf}
        \end{block}
    \end{columns}
\end{frame}
