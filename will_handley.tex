...
\begin{frame}
    ...
    \begin{itemize}
        \item \textbf{February 2025}: Models acquired PhD-student capabilities (o3, Gemini 2.5, Claude 3.5).
            \begin{itemize}
                \item Code development, mathematical reasoning, literature review, paper \& grant drafting.
            \end{itemize}
        \item \textbf{May 2025}: Agentic systems (Claude Code, Cursor) moved us from ``chatting'' to ``doing.''
            \begin{itemize}
                \item Writing and running test suites, assembling pip-installable codes, submitting grants.
            \end{itemize}
...
\begin{frame}
    ...
    \begin{columns}
        \column{0.6\textwidth}
        \begin{itemize}
            \item If you get too skilled at chat-based AI, you become a copy-paste-run-debug monkey.
            ...
            \item Agentic systems are (partially) grounded in reality. Correctly guided, they reduce hallucinations.
            \item \textbf{Claude Code:} Best in class.
            \item Competitors: Gemini CLI, Codex.
...
\begin{frame}
    \frametitle{Prompt Engineering $\to$ Context Engineering}
    \framesubtitle{The dominant discussion moving into 2026}

    \begin{itemize}
        \item \textbf{Definition:} The systematic curation of the documents, rules, and constraints provided to an AI agent's working memory.
        \item \textbf{Why it matters for research:}
            \begin{itemize}
                \item Models like Gemini 3 and Claude 4.5 have massive context windows (2M+ tokens).
                \item The bottleneck is no longer intelligence, but \emph{information}.
                \item If the agent doesn't ``know'' your specific notation or library version, it will revert to generic (wrong) training data.
            \end{itemize}
    \end{itemize}

    \vspace{0.3cm}

    \begin{block}{Practical Implementation: The Context File}
        \begin{itemize}
            \item \textbf{Create a file} (e.g., \texttt{CLAUDE.md}) in your repo root.
            \item \textbf{Include:} Project goals, mathematical conventions, citation keys, and ``forbidden'' libraries.
            \item \textbf{Effect:} Agents read this automatically before every task, maintaining consistency across weeks of work.
        \end{itemize}
    \end{block}
\end{frame}
