    ...
    \begin{columns}
        ...
        \begin{itemize}
            \item How do you know how far away anything is?
                ...
                \end{itemize}
            \item<3-> Parallax is the archetypal cosmological \textbf{geometric} measurement\ldots \hfill \arxiv{2023A&A...674A...1G}
...
\begin{frame}
    ...
    \begin{columns}
        \column{0.5\textwidth}
        \begin{itemize}
            \item<1-> Standard Candles: Objects with known intrinsic luminosity. \hfill \arxiv{2024arXiv240302801A}
            \item<2-> Supernovae Type Ia (SNe Ia): Exploding white dwarfs, used at higher redshifts. \hfill \arxiv{2022vxf}
            \item<3-> Cepheids: Variable stars with period-luminosity relation, crucial for calibrating SNe Ia. \hfill \arxiv{2024arXiv240302801A}
            \item<4-> TRGB stars: Tip of the Red Giant Branch stars, used as an alternative to Cepheids. \hfill \arxiv{2024nim}
            \item<5-> JAGB stars: J-region Asymptotic Giant Branch stars, another alternative to Cepheids. \hfill \arxiv{2024yoe}
...
\begin{frame}
    ...
    \begin{columns}
        ...
        \begin{itemize}
            ...
            \item<2-> CMB: Cosmic Microwave Background, fluctuations give a standard ruler at z$\sim$1100. \hfill \arxiv{1992ApJ...396L...1S}
            \item<3-> BAO: Baryon Acoustic Oscillations, sound waves in early universe imprint a standard ruler on galaxy distribution. \hfill \arxiv{2013agg}
            \item<4-> Strong lensing: Time delays between multiple images of a lensed object constrain distances. \hfill \arxiv{1964MNRAS.128..307R}
...
\begin{frame}
    ...
    \begin{columns}
        \column{0.55\textwidth}
        \begin{itemize}
            \item<1-> CMB:  "Surface of last scattering" at $z\sim1100$.  Angular size of hot/cold spots gives a standard ruler. \hfill \arxiv{1992ApJ...396L...1S}
            \item<2-> Temperature fluctuations: $\Delta T/T \sim 10^{-5}$.  \hfill \arxiv{1992ApJ...396L...1S}
...
\begin{frame}
    ...
    \begin{columns}
        \column{0.55\textwidth}
        \begin{itemize}
            \item<1-> BAO: Sound waves in the early Universe imprint a characteristic scale on the distribution of baryons (and galaxies). \hfill \arxiv{2013agg}
            \item<2-> SDSS: Sloan Digital Sky Survey, one of the first surveys to measure BAO. \hfill \arxiv{2005xqv}
            \item<3-> DESI: Dark Energy Spectroscopic Instrument, current best BAO measurements. \hfill \arxiv{2024lzq}
        \end{itemize}
        \column{0.45\textwidth}
...
\begin{frame}
    ...
    \begin{columns}
        \column{0.55\textwidth}
        \begin{itemize}
            \item<1-> Strong Lensing: Light from a distant object is bent by the gravity of a massive foreground object (e.g., a galaxy or galaxy cluster). \hfill \arxiv{1964MNRAS.128..307R}
            \item<2-> Time Delays: Differences in path lengths of multiple images lead to time delays, which can be used to measure distances. \hfill \arxiv{2022aqp}
        \end{itemize}
        \column{0.45\textwidth}
...
\begin{frame}
    ...
    \begin{columns}
        ...
        \begin{itemize}
            ...
            \item<1-> Surveys like DES, KiDS, and HSC have used weak lensing to map the distribution of dark matter. \hfill \arxiv{2016kym, 2019fkq}
        \end{itemize}
        \column{0.45\textwidth}
...
\begin{frame}
    ...
    \begin{columns}
        \column{0.5\textwidth}
        \begin{itemize}
            \item<1-> Standard Sirens: Gravitational wave sources with known intrinsic "loudness". \hfill \arxiv{1986gp,2005df}
            \item<2-> Bright sirens: GW events with an electromagnetic counterpart, allowing redshift measurement. \hfill \arxiv{2017adf}
            \item<3-> Dark sirens: GW events without an electromagnetic counterpart; statistical redshift information is used. \hfill \arxiv{2019ccw}
            \item<4-> Spectral sirens: Redshift is inferred statistically from the mass distribution of merging black holes. \hfill \arxiv{2019twy}
        \end{itemize}
...
\begin{frame}
    ...
    \begin{columns}
        ...
        \begin{itemize}
            ...
            \item<2-> Cosmic Chronometers: Passively evolving galaxies whose age can be measured, giving $dH/dz$. \hfill \arxiv{2001gg}
...
\begin{frame}
    ...
    \begin{columns}
        \column{0.5\textwidth}
        \begin{itemize}
            \item CMB: $H_0=67.4\pm0.5$ km/s/Mpc. \hfill \arxiv{2018vyg}
            \item S$H_0$ES: $H_0=73.2\pm1.3$ km/s/Mpc. \hfill \arxiv{2021jrx}
...
\begin{frame}
    ...
    \begin{columns}
        ...
        \begin{itemize}
            ...
            \item CMB: $S_8 \approx 0.834$. \hfill \arxiv{2018vyg}
            \item Weak lensing:  $S_8 \approx 0.76$. \hfill \arxiv{2016kym,2019fkq}
