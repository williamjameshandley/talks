...
\begin{frame}
    ...
    \begin{columns}
        ...
        \]
            ...
            \item If you want to innovate at the frontier of SBI+NS, this is its USP.
        \end{itemize}
        \column{0.5\textwidth}
    ...
    \end{itemize}
        ...
        \begin{itemize}
            \item Time complexity\vspace{-5pt}
                \[ \boxed{T = n_\mathrm{live} \times T_\mathcal{L} \times T_\mathrm{sampler} \times \mathcal{D}_\mathrm{KL}(\mathcal{P}||\pi)} \vspace{-20pt} \]
                \begin{itemize} 
                    \item \texttt{PolyChord}: $T_\mathrm{sampler}\sim\mathcal{O}(d)$
                    \item \texttt{MultiNest}: $T_\mathrm{sampler}\sim\mathcal{O}(d)$
                \end{itemize}
        \end{itemize}
    \end{columns}
