...
\begin{frame}
    ...
    \begin{itemize}
        ...
        \item Bayesian model dimensionality $d = 2\times\mathrm{var}(\log\mathcal{L})$  \arxiv{1903.06682}
...
\end{frame}
\begin{frame}
    \frametitle{Suspiciousness \arxiv{1902.04029}}
...
\begin{frame}
    ...
    \centerline{
        \begin{tabular}{llrl}
            ...
            \hline
            DES vs Planck& $\Lambda$CDM & 2.1$\sigma$ & \arxiv{2007.08496}\\
