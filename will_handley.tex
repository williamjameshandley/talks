...
\begin{frame}
    ...
    \begin{columns}[T]
        ...
        \begin{overpic}[width=\textwidth]{figures/desi.pdf}
            \put(80,75) {\tiny \arxiv{2404.03002}}
        \end{overpic}
    \end{columns}
\end{frame}

% --- SLIDE 1b: Gravitational Waves ---
\begin{frame}
...
\begin{frame}
    ...
    \begin{columns}[T]
        ...
        \begin{overpic}[width=\textwidth]{figures/exoplanet.pdf}
            \put(70,25) {\tiny \arxiv{1805.08211}}
        \end{overpic}
    \end{columns}
\end{frame}

% --- SLIDE 1d: Common Challenges ---
\begin{frame}
...
% --- SLIDE 3: Chi-squared Maximization ---
\begin{frame}
...
% --- SLIDE 6: Hamiltonian Monte Carlo (HMC) ---
\begin{frame}
...
% --- SLIDE 7: Ensemble Sampling (emcee) ---
\begin{frame}
...
% --- SLIDE 8: Why Evidence Calculation Matters ---
\begin{frame}
...
% --- SLIDE 10: How Nested Sampling Estimates Volumes ---
\begin{frame}
...
% --- SLIDE 11: Practical Guidance for Nested Sampling ---
\begin{frame}
    \frametitle{Practical Guidance: How to Use Nested Sampling}
    \framesubtitle{\tthref{github.com/williamjameshandley/talks/tree/sydney\_2024}}
    \vspace{-1em}
    \begin{columns}[T]
        \column{0.49\textwidth}
...
% --- SLIDE 14: Modern Languages: Two Independent Capabilities ---
\begin{frame}
...
% --- SLIDE 15: BlackJAX: GPU Native Sampling ---
\begin{frame}
...
% --- SLIDE 16: Case Study 1: CMB and Cosmic Shear ---
\begin{frame}
...
% --- SLIDE 17: Case Study 2: Bayesian Anomaly Detection for SNe ---
\begin{frame}
    \frametitle{Recent GPU-Accelerated Applications}
...
% --- SLIDE 18: Case Study 3: Dark Energy vs Systematics ---
\begin{frame}
    \frametitle{Recent GPU-Accelerated Applications}
...
% --- SLIDE 19: Case Study 4: Gravitational Waves ---
\begin{frame}
    \frametitle{Recent GPU-Accelerated Applications}
...
% --- SLIDE 20: Getting Started with BlackJAX ---
\begin{frame}[fragile]
...
% --- SLIDE 21: The Future: AI in Scientific Code Development ---
\begin{frame}
...
% --- SLIDE 22: AI-Assisted Code Development Case Studies ---
\begin{frame}
    ...
    \begin{block}{Rapid Development}
        \begin{itemize}
            \item \textbf{Sam Leeney}: JAX-bandflux \arxiv{2504.08081} -- first draft vibe-coded with Roo in 3 hours
            \item \textbf{Toby Lovick}: 100$\times$ speedup using Claude Code to optimize existing JAX code \arxiv{2509.13307}
            \item \textbf{Will Handley}: This talk + emcee \citehref{https://github.com/blackjax-devs/blackjax/pull}{797}{PR \#} written with LLM help. Transformational capability using Gemini and GPT-5 for interactive debugging, optimization, porting between samplers (cosmosis/cobaya/montepython), writing grants, reviewing papers, and transcribing meetings.
        \end{itemize}
    \end{block}
