...
\begin{frame}
    ...
    \begin{itemize}
        ...
        \item Likelihood-based methods have to pragmatically assume a fiducial cosmology. 
...
\begin{frame}
    ...
    \begin{columns}
        ...
        \begin{itemize}
            ...
            \item Have also made progress on the first simulation-based nested sampler \texttt{PolySwyft}~\arxiv{2403.02314} (presenting at EuCAIFCon)
        \end{itemize}
