...
\begin{frame}
    ...
    \begin{columns}
        ...
        \end{itemize}
        \column{0.48\textwidth}
        \includegraphics<1>[width=\textwidth]{2509.13220/plots/des5yoffset_20_wa.pdf}%
        \includegraphics<2>[width=\textwidth]{2509.13220/plots/desidr2_des5yoffset_20_wa.pdf}
    \end{columns}
\end{frame}
