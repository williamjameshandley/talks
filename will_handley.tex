...
\begin{frame}
    ...
    \begin{columns}
        ...
        \includegraphics[height=0.4\textwidth]{figures/flexknots.pdf}%
        \includegraphics[height=0.4\textwidth]{figures/pps_planck.pdf}
    ...
    \begin{columns}
        ...
        \begin{columns}
            ...
            \begin{overpic}[width=\textwidth]{figures/qic.pdf}
                \put(65,-4) {\tiny \arxiv{1607.04148}}
            \end{overpic}
            \vspace{-5pt}

            \begin{overpic}[width=\textwidth]{figures/pgt.pdf}
                \put(65,0) {\tiny \arxiv{2003.02690}}
            \end{overpic}
            \column{0.5\textwidth}
    ...
    \begin{columns}
        ...
        \begin{itemize}
            ...
            \item \texttt{FlexKnots}
                \begin{itemize}
                    \item importing ideas from inflationary reconstrution into reionisation \arxiv{2310.05608}(Heimersheim) \& ionospheric reconstruction \arxiv{2311.14537}(Shen).
                \end{itemize}
...
\begin{frame}
    ...
    \begin{columns}
        ...
        \begin{itemize}
            ...
            \item Alvin Chua \& Chris Moore~\arxiv{1803.10210}
            \item Metha Prathaban~\arxiv{2404.16428}
            \item Covered use of \texttt{margarine}~\arxiv{2207.11457} as alternative to GW hierarchical modelling at inaugural data science discussion group
        \end{itemize}
        \column{0.5\textwidth}
