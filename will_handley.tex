...
\begin{frame}
    ...
    \begin{columns}
        ...
        \end{itemize}
        \column{0.48\textwidth}
        \includegraphics[width=\textwidth]{2509.13394/images/normalized_difference_bars_Ia_all.png}
    \end{columns}
\end{frame}
...
\begin{frame}
    ...
    \begin{columns}
        ...
        \end{itemize}
        \column{0.48\textwidth}
        \includegraphics[width=\textwidth]{2509.13220/plots/tension.pdf}
    \end{columns}
\end{frame}
...
\begin{frame}
    ...
    \begin{columns}
        ...
        \end{itemize}
        \column{0.48\textwidth}
        \includegraphics[width=\textwidth]{prathaban_handley_2509.04336/figures/walltime_speedup.pdf}
    \end{columns}
\end{frame}
