...
\begin{frame}
    \frametitle{State-of-the-art Nature review}
    \begin{columns}
        \column{0.5\textwidth}
        \begin{itemize}
...
\begin{frame}
    ...
    \begin{itemize}
        ...
        \item i.e. how they sample from the hard likelihood constraint
            \[\{\theta\sim \pi : \mathcal{L}(\theta)>\mathcal{L}_* \}\]
    \end{itemize}
    \vspace{-10pt}
    \begin{columns}[t]
...
\begin{frame}
    ...
    \begin{itemize}
        ...
        \item This post processing suite is encapsulated in the continuously integrated python packages of \texttt{anesthetic}~\arxiv{1905.04768} and \texttt{nestcheck}~\arxiv{1704.03459}~\arxiv{1804.06406}
    \end{itemize}
...
\begin{frame}
    \frametitle{Insertion indices}
\end{frame}


\begin{frame}
    \begin{itemize}
        \item Multi temperature sampling
    \end{itemize}
\end{frame}
