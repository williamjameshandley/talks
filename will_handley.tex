...
\begin{frame}
    ...
    %\begin{columns}
    %    \column{0.48\textwidth}
    %    \begin{block}{Forward nested sampling}
    %        \[ X_{i} = t_i X_{i-1},\quad P(t_i) = n_i t^{n_i-1},\quad X_0=1 \]
    %    \end{block}
    %    \column{0.48\textwidth}
    %    \begin{block}{Reversible nested sampling}
    %        \[ X_{i} = t_i X_{i-1},\quad P(t_i) = n_i t^{n_i-1},\quad X_0=? \]
    %    \end{block}
    %\end{columns}
    \begin{columns}
        \column{0.5\textwidth}
