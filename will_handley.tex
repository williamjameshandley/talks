...
\begin{frame}
    ...
    \begin{columns}[c]
        ...
        \begin{itemize}
            \item \textbf{Task}: Port the DES Y3 likelihood to Cobaya
            \item State-of-the-art, but locked into Cosmosis
            \item Need it in Cobaya to combine consistently with CMB
        ...
        $\downarrow$\\
        \vspace{3pt}
        \includegraphics[width=0.8\textwidth]{logos/cobaya.png}
    \end{columns}
\end{frame}
