...
\begin{frame}
    ...
    \begin{columns}
        ...
        \begin{itemize}
            ...
            \item This is due to the curse of dimensionality: need to sum $N^d$ units to compute $\approx \sum_i f(x_i) \Delta V_i$
            \item Estimating volumes with geometry becomes exponentially hard as $d$ increases.
