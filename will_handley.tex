...
\begin{frame}
    ...
    \begin{columns}
        ...
        \end{itemize}
        \column{0.48\textwidth}
        \includegraphics[width=0.49\textwidth]{2509.13220/plots/dmb_desidr2_des5y.pdf}%
        \hfill%
        \includegraphics[width=0.49\textwidth]{2509.13220/plots/desidr2_des5yoffset_20_wa.pdf}
    \end{columns}
\end{frame}
