...
\begin{frame}
    ...
    \begin{columns}[c]
        \column{0.55\textwidth}
        \begin{block}{The Problem}
            Preparing a talk, needed an \texttt{emcee} animation equivalent to my nested sampling one. No GPU implementation existed.
        \end{block}
        \begin{block}{The Solution}
            ...
            \begin{itemize}
                ...
                \item The \texttt{emcee} GitHub repository
                \item The BlackJAX repository
            \end{itemize}
            Asked it to implement \texttt{emcee} in BlackJAX.
        \end{block}
        \begin{alertblock}{Result}
            Working PR in 15 minutes. Now under review.\\
            \small{\tthref{github.com/blackjax-devs/blackjax/pull/797}}
        \end{alertblock}
        \column{0.4\textwidth}
        \centering
        \includegraphics[width=\textwidth,page=9]{figures/himmelblau_emcee.pdf}
    \end{columns}
\end{frame}
