...
\begin{frame}
    \frametitle{GPU-Accelerated Applications: Type Ia Supernovae}
...
\begin{frame}
    \frametitle{GPU-Accelerated Applications: Gravitational Waves}
    \student{metha_prathaban}{Metha Prathaban}{PhD}
    \begin{columns}[c]
        \column{0.55\textwidth}
        \begin{block}{GPU-Native Nested Sampling \arxiv{2509.04336}}
            \begin{itemize}
...
\begin{frame}
    ...
    \begin{columns}[c]
        ...
        \column{0.4\textwidth}
        \centering
        \textit{[emcee animation placeholder]}
    \end{columns}
\end{frame}
