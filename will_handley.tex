    ...
    \begin{columns}
        ...
        \begin{itemize}
            ...
            \item This is an exponential contraction, so
                \[  \sum_i f(x_i) \Delta V_i, \qquad V_i = V_0 e^{-\only<9->{(}i\only<5->{\pm\sqrt{i})}/n} \]
...
\end{frame}
\begin{frame}
    \frametitle{Likelihood-free inference (aka Simulation based inference)}
    \begin{columns}
        \column{0.5\textwidth}
        \vspace{-10pt}
        \begin{itemize}
